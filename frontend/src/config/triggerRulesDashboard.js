...
export default {
  ...
  stepper: {
    ...
    settingsFormSchema: [
      ...
      { key: "maxRetries", label: "Max retries", type: "number", min: 0, required: true },
      { key: "parallelLimit", label: "Parallel limit", type: "number", min: 1, required: true },
      { key: "timeout", label: "Timeout (seconds)", type: "number", min: 1, required: true },
    ],
    eventField: {
      key: "triggerEventId",
      label: "When (event)",
