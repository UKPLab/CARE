        ...
        <tr v-for="item in items" :key="item.hash">
          ...
          <td>
            <div class="btn-group">
              ...
              <button v-if="admin===true" :class="item.accepted === null ? 'disabled' : ''"
...
<script>
/* Reviews.vue - dashboard component for handling reviews

This dashboard component provides a view to get an overview over the available reviews
