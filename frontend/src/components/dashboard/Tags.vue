        ...
        <tr v-for="tagSet in tagSets" :key="tagSet.id">
          ...
          <td>
            <div aria-label="Basic example" class="btn-group  btn-group-sm" role="group">
              <button :disabled="tagSet['userId'] === userId" class="btn btn-outline-dark btn-sm"
              ...
              <button class="btn btn-outline-dark btn-sm" v-on:click="this.$refs.tagSetModal.copy(tagSet.id)">
              ...
              <button v-tooltip class="btn btn-outline-dark btn-sm" title="test" @click="shareTagSet(tagSet.id)">
