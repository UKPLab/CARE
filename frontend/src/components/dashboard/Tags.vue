<template>
  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      Tag Sets
      <button class="btn btn-primary btn-sm" v-on:click="this.$refs.tagSetModal.new()">Add new tag set</button>
    </div>
        ...
        <tr v-for="tagSet in tagSets" :key="tagSet.id">
          ...
          <td>
            <div aria-label="Basic example" class="btn-group  btn-group-sm" role="group">
              ...
              <button v-tooltip title="Delete" v-if="tagSet.userId === userId || isAdmin" class="btn btn-outline-dark btn-sm" @click="deleteTagSet(tagSet.id)">
              ...
              <button v-if="!tagSet.publish && (tagSet.userId === userId || isAdmin)" v-tooltip title="Share" class="btn btn-outline-dark btn-sm"  @click="shareTagSet(tagSet.id)">
