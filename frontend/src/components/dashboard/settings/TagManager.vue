<template>
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      Tag Sets
      <button class="btn btn-primary btn-sm" @click="addTagSet">Add new tag set</button>
    </div>
        ...
        <tr v-for="tagSet in tagSets" :key="tagSet.id">
          ...
          <td>
            <div class="btn-group  btn-group-sm" role="group" aria-label="Basic example">
              <button class="btn btn-outline-dark btn-sm" @click="editTagSet(tagSet.id)">
...
export default {
  ...
  computed: {
    ...mapGetters({tagSets: 'tag/getTagSets', tags: 'tag/getTags'}),
  },
  watch: {
