  ...
  computed: {
    ...
    studyFilterSchema() {
      return {
        ...
        sessions: {label: this.$t('studies.columns.sessions'), type: "numeric"},
        limitSessions: {label: this.$t('studies.columns.sessionLimit'), type: "numeric"},
        limitSessionsPerUser: {label: this.$t('studies.columns.sessionLimitPerUser'), type: "numeric"},
