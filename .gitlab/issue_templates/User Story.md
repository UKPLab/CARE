...
(Example: As a user of the system, after highlighting a text inside of the Annotator.vue, a pen icon should appear with which I can initiate a change of the text (edit mode).)
