...
* To use any functionality that includes downloading submissions files, the administrator needs to enable "Can Download File" in the Active External Web Service. This includes the following steps:
  ...
  The information was taken from this `site:  <https://edwiser.helpscoutdocs.com/article/559-how-to-enable-can-download-file-in-the-active-external-web-service>`_. You can also find a visual guide there.
...
After the 'make docker' command, you should see 'moodle...container recreated' in the console. This means that your changes have been detected and integrated.
