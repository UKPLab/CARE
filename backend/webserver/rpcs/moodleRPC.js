...
module.exports = class MoodleRPC extends RPC {
    ...
    async init() {
        ...
        console.log("MoodleRPC initialized");
        //this.call("Hello");
    }
    ...
    callMoodleService(data) {
        return new Promise((resolve, reject) => {
            const scriptPath = path.resolve(__dirname, '../../moodle/main.py');
            ...
            // Collect error messages from Python script's stderr
