...
module.exports = function (server) {
    server.app.get('/config.js', async (req, res) => {
        const config = {
            ...
            "system.auth.loginMethods.orcid.enabled": await server.db.models['setting'].get("system.auth.loginMethods.orcid.enabled"),
            "system.auth.loginMethods.ldap.enabled": await server.db.models['setting'].get("system.auth.loginMethods.ldap.enabled"),
            "system.auth.loginMethods.saml.enabled": await server.db.models['setting'].get("system.auth.loginMethods.saml.enabled"),
